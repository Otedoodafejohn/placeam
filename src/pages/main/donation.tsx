import  Pam from "../../assets/Pad.jpeg";
import  Pamper from "../../assets/Pampers.jpeg";
      ...
      <div className="flex flex-col">
        <div className="flex flex-col justify-center">
          <div className="relative">
            ...
            <div className="absolute sm:bottom-24 bottom-4 pr-10 sm:pr-0 left-4 sm:left-8 flex justify-start items-start">
              <p className="text-3xl sm:text-4xl font-semibold leading-9 text-white">Tell us us how this products will help you and it could be yours.</p>
            </div>
          </div>
        </div>
        <div className="mt-10 grid lg:grid-cols-2 gap-x-8 gap-y-8 items-start">
          <div className="group group-hover:bg-opacity-60 transition duration-500 relative bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 sm:p-28 py-36 px-10 flex justify-center items-center flex-1">
            <img className="group-hover:opacity-60 transition duration-500 aspect-square" src={Pam} alt="sofa-2" />
            <div className="absolute sm:top-8 top-4 left-4 sm:left-8 flex justify-start items-start flex-col space-y-2">
              <div>
                <p className="group-hover:opacity-60 transition duration-500 text-xl leading-5 text-gray-600 dark:text-white">Pad</p>
              </div>
              <div>
          ...
          <div className="group group-hover:bg-opacity-60 transition duration-500 relative bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 sm:p-28 py-36 px-10 flex justify-center items-center flex-1 h-full">
            <img className="group-hover:opacity-60 transition duration-500" src={Pamper} alt="sofa-3" />
            <div className="absolute sm:top-8 top-4 left-4 sm:left-8 flex justify-start items-start flex-col space-y-2">
              <div>
