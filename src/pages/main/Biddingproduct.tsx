...
export default function Biddingproduct() {
  return (
     <main>
    ...
    {/* <!-- Tab Menu --> */}
    <div className="flex flex-wrap items-center gap-5  overflow-x-auto overflow-y-hidden py-10 justify-center text-white ">
        <button rel="noopener noreferrer"  className="flex items-center flex-shrink-0 px-5 py-3 space-x-2 rounded-tl-lg rounded-br-lg bg-gray-600">
          ...
          <button type="button">
            <div className="relative flex items-end overflow-hidden rounded-xl">
              ...
              <div className="flex items-center space-x-1.5 rounded-lg bg-blue-500 px-4 py-1.5 text-white duration-100 hover:bg-blue-600">
                ...
                <button className="text-sm">Bid</button>
              </div>
            </div>
